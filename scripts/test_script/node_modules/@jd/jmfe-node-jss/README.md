...
### acl.internetVisible(isVisible) ⇒ [<code>Acl</code>](#Acl)
网络可见<br>
...
### acl.get() ⇒ <code>Promise.&lt;Response.body&gt;</code> \| <code>Promise.&lt;Error&gt;</code>
获取权限配置<br>
...
### bucket.object(key) ⇒ [<code>JssObject</code>](#JssObject)
创建一个 JssObject
